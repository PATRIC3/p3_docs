...
|                                                                                                                                                 |                     | - `MTB Network Portal`_ - Sorted and indexed ChIP-seq files                                               |
+-------------------------------------------------------------------------------------------------------------------------------------------------+---------------------+-----------------------------------------------------------------------------------------------------------+
| `Mapping and manipulating the Mycobacterium tuberculosis transcriptome using a transcription factor overexpression-derived regulatory network`_ | `PMID: 25380655`_   | - `GEO Accession: GSE59086`_ Transcription factor overexpression data from tiling microarray experiments  |
|                                                                                                                                                 |                     | - `PATRIC: tfoe-meta.xls`_ Metadata file                                                                  |
|                                                                                                                                                 |                     | - `MTB Network Portal`_ Sample information for each experiment                                            |
+-------------------------------------------------------------------------------------------------------------------------------------------------+---------------------+-----------------------------------------------------------------------------------------------------------+
| A high-resolution network model for global gene regulation in Mycobacterium tuberculosis                                                        | `PMID: 25232098`_   | - `MTB Network Portal`_ Data sets and additional information                                              |
+-------------------------------------------------------------------------------------------------------------------------------------------------+---------------------+-----------------------------------------------------------------------------------------------------------+
| A comprehensive map of genome-wide gene regulation in Mycobacterium tuberculosis                                                                | `PMID: 25977815`_   | - `PATRIC ChIP-seq`_ ChIP-seq experiment information page                                                 |
|                                                                                                                                                 |                     | - `PATRIC: TFOE Expression`_ TFOE Experiment information page                                             |
...
+-------------------------------------------------------------------------------------------------------------------------------------------------+---------------------+-----------------------------------------------------------------------------------------------------------+
| `Network analysis identifies Rv0324 and Rv0880 as regulators of bedaquiline tolerance in Mycobacterium tuberculosis`_                           | `PMID: 27573104`_   | - `GEO Accession: GSE72459`_ Expression profiling data                                                    |
+-------------------------------------------------------------------------------------------------------------------------------------------------+---------------------+-----------------------------------------------------------------------------------------------------------+
| `MiR-155-regulated molecular network orchestrates cell fate in the innate and adaptive immune response to Mycobacterium tuberculosis`_          |                     | - `GEO Accession: GSE79733`_ Expression Profiling data                                                    |
+-------------------------------------------------------------------------------------------------------------------------------------------------+---------------------+-----------------------------------------------------------------------------------------------------------+
...
.. _`MTB Network Portal`: http://networks.systemsbiology.net/mtb/chipseq-gateway
...
.. _`MTB Network Portal`: http://networks.systemsbiology.net/mtb/content/TFOE-Searchable-Data-File
...
.. _`PATRIC: TFOE Expression 1`: https://www.patricbrc.org/webpage/website/data_collections/content/omics4tb_tfoe_expression_experiments.html
.. _`GEO Accession: GSE59086`: http://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE59086
.. _`MTB Network Portal`: http://networks.systemsbiology.net/mtb/content/TFOE-Searchable-Data-File
...
Data sets and additional information can be found `here <https://www.patricbrc.org/webpage/website/data_collections/content/omics4tb_chip_seq_experiments.html>`_.
...
Data sets and additional information can be found `here <https://www.patricbrc.org/webpage/website/data_collections/content/omics4tb_tfoe_expression_experiments.html>`_.
...
Data sets and additional information can be found `here <http://networks.systemsbiology.net/mtb/>`_.
...
Data sets and additional information can be found on these pages: `ChIP-Seq <https://www.patricbrc.org/webpage/website/data_collections/content/omics4tb_chip_seq_experiments.html>`_, `Expression Data <https://www.patricbrc.org/webpage/website/data_collections/content/omics4tb_tfoe_expression_experiments.html>`_, `Network Model <http://networks.systemsbiology.net/mtb/>`_.
...
Data sets and additional information can be found `here <https://www.patricbrc.org/webpage/website/data_collections/content/omics4tb_bedaquiline_tolerance.html>`_.
...
Data sets and additional information can be found `here <https://www.patricbrc.org/webpage/website/data_collections/content/omics4tb_macrophage_mtb_infection.html>`_.