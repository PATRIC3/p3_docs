...
**P-Value Threshold:** Sets the maximum allowable p-value associated with the [Mash](https://genomebiology.biomedcentral.com/articles/10.1186/s13059-016-0997-x) Jaccard estimate used in calculating the distance.
