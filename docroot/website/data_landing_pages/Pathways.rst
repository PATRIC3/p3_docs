    ...
    <section class="main">
      ...
      <div class="data-tab" id="tab1">
        <h3>PATRIC Data is Linked to Associated Biochemical Pathways</h3>
          <div class="large">
            <p>Our analysis tools and interactive visualizations allow users to highlight regions of genome loss or
             conservation and ultimately look for changes within the context of functional pathways. Pathways of interest
             can be identified using the 
             <a href="http://docs.patricbrc.org/user_guides/organisms_taxon/pathways.html" target="_blank">Comparative Pathway Tool</a>
        ...
        <div class="data-box collapse-bottom" id="dlp-pathways-conservation-header">
          ...
          <p class="desc" style="margin:0">The graph below shows conservation of metabolic pathways across percentage of total genomes in each pathogenic genus.</p>
        </div><!-- /data-box -->
